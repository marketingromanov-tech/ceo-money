...
class Index extends Component
{
    ...
    public function approve(WithdrawalWorkflowService $service):void{if (! $this->requireRecentAdminAuthentication()) return;$this->run(fn()=> $service->approve($this->selected(),auth()->user()),'Заявка одобрена.');}
